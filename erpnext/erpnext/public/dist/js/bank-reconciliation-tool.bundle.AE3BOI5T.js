(() => {
  ...
  erpnext.accounts.bank_reconciliation.DataTableManager = class DataTableManager {
    constructor(opts) {
      ...
      this.dialog_manager = new erpnext.accounts.bank_reconciliation.DialogManager(this.company, this.bank_account);
      this.make_dt();
    }
    make_dt() {
      var me = this;
...
//# sourceMappingURL=bank-reconciliation-tool.bundle.AE3BOI5T.js.map
