(() => {
    ...
    const dialog = new frappe.ui.Dialog({
      ...
      primary_action: function() {
        ...
        alternative_items.forEach((d) => {
          ...
          frm.script_manager.trigger(item_field, row.doctype, row.name).then(() => {
        ...
        $.each(r.message, function(_i, d) {
          frappe.ui.form.on(d, {
            ...
            refresh: function(frm) {
              if (frm.doc.status !== "Closed" && frm.doc.service_level_agreement && frm.doc.agreement_status === "Ongoing") {
                frappe.call({
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_selector.html
...
{% endfor %}
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/public/js/templates/employees_to_mark_attendance.html
...
`;
  ...
  frappe.help.help_links["Form/PayPal Settings"] = [
    {
      ...
      url: docsUrl + "user/manual/en/setting-up/integrations/paypal-integration"
    }
  ];
  frappe.help.help_links["Form/Razorpay Settings"] = [
    {
      label: "Razorpay Settings",
      url: docsUrl + "user/manual/en/setting-up/integrations/razorpay-integration"
    }
  ];
  ...
  frappe.help.help_links["Form/LDAP Settings"] = [
    {
      label: "LDAP Settings",
      url: docsUrl + "user/manual/en/setting-up/integrations/ldap-integration"
    }
  ];
  frappe.help.help_links["Form/Stripe Settings"] = [
    {
      label: "Stripe Settings",
      url: docsUrl + "user/manual/en/setting-up/integrations/stripe-integration"
    }
  ];
  ...
  frappe.help.help_links["List/Stock Reconciliation"] = [
    {
      ...
      url: docsUrl + "user/manual/en/setting-up/stock-reconciliation-for-non-serialized-item"
    }
  ];
  ...
  frappe.help.help_links["Form/Dropbox Backup"] = [
    ...
    },
    {
      ...
      url: docsUrl + "user/manual/en/setting-up/articles/setting-up-dropbox-backups"
    }
  ];
  ...
  frappe.help.help_links["List/Company"] = [
    ...
    },
    {
      ...
      url: docsUrl + "user/manual/en/setting-up/articles/managing-multiple-companies"
    },
    {
  ...
  frappe.help.help_links["Form/Sales Person"] = [
    {
      ...
      url: docsUrl + "user/manual/en/selling/setup/sales-person-target-allocation"
    }
  ];
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_quick_entry.html
...
<div class="attributes hide-control">
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/public/js/education/student_button.html
  frappe.templates["student_button"] = `<div class="col-sm-3">
    <div class="checkbox">
        <label>
            <input 
                type="checkbox"
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/public/js/education/assessment_result_tool.html
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/public/js/templates/call_link.html
...
//# sourceMappingURL=erpnext.bundle.274P2GEA.js.map
