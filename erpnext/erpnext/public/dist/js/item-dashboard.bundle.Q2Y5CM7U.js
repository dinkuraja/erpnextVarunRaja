(() => {
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/stock/dashboard/item_dashboard.html
  frappe.templates["item_dashboard"] = `<div>
	<div class="result">
	</div>
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/stock/dashboard/item_dashboard_list.html
...
`;
  ...
  erpnext.stock.move_item = function(item, source, target, actual_qty, rate, callback) {
    ...
    dialog.set_primary_action(__("Submit"), function() {
      ...
      frappe.call({
        ...
        callback: function(r) {
          frappe.show_alert(__("Stock Entry {0} created", ['<a href="/app/stock-entry/' + r.message.name + '">' + r.message.name + "</a>"]));
          dialog.hide();
          callback(r);
        }
      });
    });
    $('<p style="margin-left: 10px;"><a class="link-open text-muted small">' + __("Add more items or open full form") + "</a></p>").appendTo(dialog.body).find(".link-open").on("click", function() {
      frappe.model.with_doctype("Stock Entry", function() {
        var doc = frappe.model.get_new_doc("Stock Entry");
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/stock/page/warehouse_capacity_summary/warehouse_capacity_summary.html
...
{% endfor %}`;
  ...
  // frappe-html:/Users/lucson/Desktop/Belito/frappe-bench/apps/erpnext/erpnext/stock/page/warehouse_capacity_summary/warehouse_capacity_summary_header.html
...
//# sourceMappingURL=item-dashboard.bundle.Q2Y5CM7U.js.map
